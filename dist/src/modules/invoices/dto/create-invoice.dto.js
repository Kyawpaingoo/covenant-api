...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'uuid-of-contract' }),
    (0, class_validator_1.IsString)(),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 10, description: 'Tax rate percentage (0-100)' }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ enum: client_1.InvoiceStatus, default: 'DRAFT' }),
